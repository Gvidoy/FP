...
clase realiza una serie de operaciones con ellos.
Pareja de enteros
EJERCICIO 16 RELACION 3
...
int main(){
	...
	cout << "El segundo entero es: " << objeto1.GetEntero2() << endl << endl;
	
	cout << "--------------------->\n";
	//Cambio los valores de los datos de la clase con lor metodos SetEntero1 y
	//SetEntero2

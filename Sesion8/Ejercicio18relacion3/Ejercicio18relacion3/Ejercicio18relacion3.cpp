...
opcion con un menu dentro de una clase
Pareja de enteros
EJERCICIO 18 RELACION 3
...
//***************************************************************************
//Metodo Para recivir la opcion
	void SelecionaOpcion(int opcion_menu){

	opcion = opcion_menu;
	}
//***************************************************************************
//Metodo para el menu	
	void MostrarMenu(int n1, int n2)
	{
		//Objeto para la clase de operaciones
		ParejaEnteros objeto1;
...
int main(){
	...
	do{
		...
		objetoMenu.SelecionaOpcion(opcion_menu);
		objetoMenu.MostrarMenu(entero1,entero2);

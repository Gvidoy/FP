/*
Se añanden un metodo para eliminar una componente del vector
Ejercicio4 Relacion4
...
public:
	...
	//**************************************************************************
	//En este metodo elimina una componente del vector
...
int main(){
   ...
   MiVectorCaracteres objeto1;
	...
	//Solicito la posicion a borrar
	cout << "\nIntroduce la posicion del vector a borrar: ";
	cin >> pos;
	cout << endl;

	//Le paso los parametros al metodo elimina
	objeto1.Elimina(pos);
